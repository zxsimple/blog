...
[![distributed_web_log_apache_module](https://github.com/zxsimple/blog/raw/master/wp-content/uploads/2016/02/distributed_web_log_apache_module.png)](https://github.com/zxsimple/blog/blob/master/wp-content/uploads/2016/02/distributed_web_log_apache_module.png)

### 自定义Apache模块

1. 生成helloworld模块模板
2. 在此模板中有两个重要的方法helloworld_register_hooks和helloworld_handler

3. ```bash
   sudo /usr/share/apache/bin/apxs -g -n helloworld
   ```

4. 在Apache加载阶段将通过hook机制执行helloworld_register_hooks函数然后将helloworld_handler注册到到钩子上去。 当Apache接收到请求后将会调用helloworld_handler来处理此请求。
...
8. 然后到/usr/local/apache/conf/httpd.conf 中加入
...
这两种代理的区别是前者客户端知道目标资源，而不知道代理的存在；后者客户端只知道代理服务器的存在，而不知道此资源的最终提供者。 [![distributed_web_log_reverse_proxy](https://github.com/zxsimple/blog/raw/master/wp-content/uploads/2016/02/distributed_web_log_reverse_proxy.png)](https://github.com/zxsimple/blog/blob/master/wp-content/uploads/2016/02/distributed_web_log_reverse_proxy.png) 而对于设置apache的反向代理是非常简单的，只要修改ProxyRequest Off就可以
...
[![distributed_web_log_rabbitmq](https://github.com/zxsimple/blog/raw/master/wp-content/uploads/2016/02/distributed_web_log_rabbitmq.png)](https://github.com/zxsimple/blog/blob/master/wp-content/uploads/2016/02/distributed_web_log_rabbitmq.png)

### RabbitMQ消息队列的使用过程大概如下
...
[![distributed_web_log_mq](https://github.com/zxsimple/blog/raw/master/wp-content/uploads/2016/02/distributed_web_log_mq.jpg)](https://github.com/zxsimple/blog/blob/master/wp-content/uploads/2016/02/distributed_web_log_mq.jpg)
...
1. http://www.cnblogs.com/brucewoo/archive/2011/12/13/2285482.html
2. http://dongxicheng.org/search-engine/scribe-intro/

### Kafka

1. https://kafka.apache.org/
2. http://research.microsoft.com/en-us/um/people/srikanth/netdb11/netdb11papers/netdb11-final12.pdf
3. http://atcc.mysqlops.com/pdf/vipshop.pdf
