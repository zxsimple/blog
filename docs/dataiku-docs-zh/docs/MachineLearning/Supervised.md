...
此外，根据DSS[依赖的计算引擎](dataiku-docs-zh/docs/MachineLearning/Engines.md)DSS能够随机拆分数据集样本。对于像[Scikit-learn/XGBoost](dataiku-docs-zh/docs/MachineLearning/Engines/Sklearn.md)这样的内存计算引擎来说尤为重要。DSS默认用数据集中的前100000条。
...
## 设置：特征处理
参见[特征处理](dataiku-docs-zh/docs/MachineLearning/Feature-handling.md)
...
算法依赖与计算引擎，详情参考[机器学习引擎](dataiku-docs-zh/docs/MachineLearning/Engines.md)
